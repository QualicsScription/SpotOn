...
=============================="""
    ...
    def update_texts(self):
        ...
        # Eğer sonuçlar varsa, istatistik metnini güncelle
        if hasattr(self, 'stats_text') and self.stats_text.toPlainText():
            # Mevcut sonuçları kullanarak görsel analizi yeniden oluştur
            if hasattr(self.parent, 'results') and self.parent.results:
                self.update_visual_analysis(self.parent.results)